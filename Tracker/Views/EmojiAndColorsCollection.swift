...
extension EmojiAndColorsCollection: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: EmojiAndColorsCollectionCell.reuseIdentifier, for: indexPath) as? EmojiAndColorsCollectionCell else {
            return UICollectionViewCell()
        }
        switch indexPath.section {
        case 0:
            cell.layer.cornerRadius = 16
            cell.label.text = emoju[indexPath.row]
        case 1:
